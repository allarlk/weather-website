...
const reverseGeocode = (lon, lat, callback) => {
    // https://api.mapbox.com/geocoding/v5/mapbox.places/26.6489345,58.356835999999994.json?access_token=pk.eyJ1IjoiYWxsYXJsIiwiYSI6ImNrZmw0cTg2ODA5d2wycm10ZThkdzIyNWoifQ.YgCXqUYvvAdeCuV-BHzSFg&limit=1
    
    const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${lon},${lat}.json?access_token=pk.eyJ1IjoiYWxsYXJsIiwiYSI6ImNrZmw0cTg2ODA5d2wycm10ZThkdzIyNWoifQ.YgCXqUYvvAdeCuV-BHzSFg&limit=1`
